...
const BLOG = {
  AUTHOR: '白菜', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://blog.xiaocaicai.xyz', // 网站地址
  KEYWORDS: 'BC-blog, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '166bacd0c9dc4392a5f580bf7e345c53', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: '2402654997@qq.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://caiyuanzi.vip',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || '2402654997-qqcom/notion-next', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '白菜Blog', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个私人Blog', // 站点描述，被notion中的页面描述覆盖
